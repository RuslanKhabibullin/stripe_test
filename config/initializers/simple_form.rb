...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form,
                  class: :input, hint_class: :field_with_hint, error_class: :error, valid_class: :valid do |b|
    b.use :html5
    b.use :placeholder
  ...
  config.wrappers :horizontal_form,
                  tag: "div", class: "row", hint_class: :field_with_hint, error_class: :error,
  ...
  config.wrappers :inline_form,
                  tag: "div", class: "column small-4", hint_class: :field_with_hint, error_class: :error,
                  valid_class: :valid do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
